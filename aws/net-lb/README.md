...
| <a name="input_health_check"></a> [health\_check](#input\_health\_check) | Map describing Health Check settings - including endpoint (default /) and port (default 80). Applied for internal NLBs. | `map(string)` | <pre>{<br>  "healthy_threshold": "3",<br>  "interval": "20",<br>  "port": "80",<br>  "protocol": "TCP",<br>  "timeout": "10",<br>  "unhealthy_threshold": "2"<br>}</pre> | no |
